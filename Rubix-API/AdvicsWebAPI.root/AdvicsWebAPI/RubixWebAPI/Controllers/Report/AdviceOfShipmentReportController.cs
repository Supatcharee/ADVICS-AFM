...
{
    public class AdviceOfShipmentReportController : ApiController
    {
        AdviceOfShipmentReport obj = new AdviceOfShipmentReport();

        [HttpPost, HttpGet, APIAuthorize]
        public HttpResponseMessage GetDataReport(string ShipmentNo, int Installment, string ContainerNo)
        {
            List<sp_RPT042_AdivceOfShipment_GetData_Result> ResultReturn;
            try
            {
