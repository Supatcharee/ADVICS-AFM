...
namespace Rubix.Screen.Form.Operation.A_Order
{
    ...
    public partial class frmASO010_SaleOrder : FormBase
    {
        #region Member
        ...
        private void frmASO010_SaleOrder_Load(object sender, EventArgs e)
        {
            try
            {
                ClearData();
        ...
        private void DataLoading()
        {
            try
            {
                ...
                DataTable dt = BusinessClass.SaleOrderDataLoading(ownerControl.OwnerID, warehouseControl.WarehouseID, customerControl.CustomerID,
                                                                  ...
                                                                  txtCustomerPONo.Text.Trim(), txtSONo.Text, chkAllStatus.Checked ? null : DataUtil.Convert<int>(1), 0, 0);
