...
namespace Rubix.Framework
{
    ...
    public class MessageDialog : DevExpress.XtraEditors.XtraForm
    {
            ...
            , params DialogButton[] buttons)
        {
            ...
            foreach (SimpleButton btn in panelButtons.Controls)
            {
        ...
        private string GetButtonCaption(DialogButton btn)
        {
            switch (btn)
            {
                case DialogButton.Abort: return Rubix.Framework.Util.GetMenuText("Abort", "Abort");
                case DialogButton.Cancel: return Rubix.Framework.Util.GetMenuText("Cancel", "Cancel");
                case DialogButton.Ignore: return Rubix.Framework.Util.GetMenuText("Ignore", "Ignore");
                case DialogButton.No: return Rubix.Framework.Util.GetMenuText("No", "No");
                case DialogButton.NoToAll: return Rubix.Framework.Util.GetMenuText("No to all", "No to all");
                case DialogButton.OK: return Rubix.Framework.Util.GetMenuText("OK", "OK");
                case DialogButton.Retry: return Rubix.Framework.Util.GetMenuText("Retry", "Retry");
                case DialogButton.Yes: return Rubix.Framework.Util.GetMenuText("Yes", "Yes");
                case DialogButton.YesToAll: return Rubix.Framework.Util.GetMenuText("Yes to all", "Yes to all");
                case DialogButton.SendMail: return Rubix.Framework.Util.GetMenuText("Send Error", "Send Error");
                case DialogButton.Detail: return Rubix.Framework.Util.GetMenuText("Detail", "Detail");
        ...
        private void CreateButton(DialogButton[] buttons, bool bHaveDetail, DialogButton acceptButton, DialogButton cancelButton)
        {
            ...
            // create more detail
            SimpleButton btnDetail = null;
            if (bHaveDetail)
            {
                btnDetail = new SimpleButton();
                //btnDetail.FlatStyle = FlatStyle.System;
            ...
            int height = ((SimpleButton)panelButtons.Controls[panelButtons.Controls.Count - 1]).Bottom + OFFSET;
            if (height > DEFAULT_MESSAGE_HEIGHT)
            {
                panelMessage.Height = ((SimpleButton)panelButtons.Controls[panelButtons.Controls.Count - 1]).Bottom + OFFSET;
            }
            else
            {
                if (btnDetail != null)
        ...
        public static string MessageCaptions_Information
        {
            get
            {
                return Rubix.Framework.Util.GetMenuText("Information", "Information");
            }
        }
        public static string MessageCaptions_Confirmation
        {
            get
            {
                return Rubix.Framework.Util.GetMenuText("Confirmation", "Confirmation");
            }
        }
        public static string MessageCaptions_BusinessError
        {
            get
            {
                return Rubix.Framework.Util.GetMenuText("Warning", "Warning");
            }
        }
        public static string MessageCaptions_SystemError
        {
            get
            {
                return Rubix.Framework.Util.GetMenuText("Error", "Error");
            }
        }
        #endregion
